# Contributing to AslKit

Thanks for helping improve AslKit. Bug reports, focused fixes, documentation improvements, and well-scoped features are welcome.
...
- Search [existing issues](https://github.com/focale-editor/aslkit/issues) before opening a new one.
...
AslKit follows the SDK constraint in [`pubspec.yaml`](pubspec.yaml). Install a compatible stable Dart SDK, fork the repository, and run:

```sh
git clone https://github.com/YOUR_ACCOUNT/aslkit.git
cd aslkit
dart pub get
```
